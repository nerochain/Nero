...
type BlockChain interface {
	...
	// CurrentSnapBlock retrieves the head fast block from the local chain.
...
func (d *Downloader) commitPivotBlock(result *fetchResult) error {
	block := types.NewBlockWithHeader(result.Header).WithBody(types.Body{Transactions: result.Transactions})
