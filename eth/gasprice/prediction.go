...
func NewPrediction(cfg Config, backend OracleBackend, pool *txpool.TxPool) *Prediction {
...
func (p *Prediction) update() {
	...
	minPrice := wei2GWei(p.pool.GasTip())
	prices := make([]uint, 3)
