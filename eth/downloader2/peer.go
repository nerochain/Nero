...
type Peer interface {
	...
	RequestHeadersByHash(common.Hash, int, int, bool, chan *eth2.Response) (*eth2.Request, error)
	RequestHeadersByNumber(uint64, int, int, bool, chan *eth2.Response) (*eth2.Request, error)

	RequestBodies([]common.Hash, chan *eth2.Response) (*eth2.Request, error)
	RequestReceipts([]common.Hash, chan *eth2.Response) (*eth2.Request, error)
}
...
func (p *peerConnection) UpdateHeaderRate(delivered int, elapsed time.Duration) {
	p.rates.Update(eth2.BlockHeadersMsg, elapsed, delivered)
}
...
func (p *peerConnection) UpdateBodyRate(delivered int, elapsed time.Duration) {
	p.rates.Update(eth2.BlockBodiesMsg, elapsed, delivered)
}
...
func (p *peerConnection) UpdateReceiptRate(delivered int, elapsed time.Duration) {
	p.rates.Update(eth2.ReceiptsMsg, elapsed, delivered)
}

// HeaderCapacity retrieves the peer's header download allowance based on its
// previously discovered throughput.
func (p *peerConnection) HeaderCapacity(targetRTT time.Duration) int {
	cap := p.rates.Capacity(eth2.BlockHeadersMsg, targetRTT)
...
func (p *peerConnection) BodyCapacity(targetRTT time.Duration) int {
	cap := p.rates.Capacity(eth2.BlockBodiesMsg, targetRTT)
...
func (p *peerConnection) ReceiptCapacity(targetRTT time.Duration) int {
	cap := p.rates.Capacity(eth2.ReceiptsMsg, targetRTT)
