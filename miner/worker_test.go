...
func newTestWorker(t *testing.T, chainConfig *params.ChainConfig, engine consensus.Engine, db ethdb.Database, blocks int) (*worker, *testWorkerBackend) {
	...
	backend.txPool.Add(pendingTxs, !testTxPoolConfig.NoLocals, true)
...
func testGenerateBlockAndImport(t *testing.T, isClique bool) {
	...
	b.genesis.MustCommit(db2, triedb.NewDatabase(db2, triedb.HashDefaults))
	...
	for i := 0; i < 5; i++ {
		b.txPool.Add(b.newRandomTx(true), !testTxPoolConfig.NoLocals, true)
		b.txPool.Add(b.newRandomTx(false), !testTxPoolConfig.NoLocals, true)
...
func testRegenerateMiningBlock(t *testing.T, chainConfig *params.ChainConfig, engine consensus.Engine) {
	...
	b.txPool.Add(newTxs, !testTxPoolConfig.NoLocals, true)
